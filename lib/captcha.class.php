...
class lib_captcha{
    ...
    private function createImg()
    {
        ...
        $bgColor = imagecolorallocate($this->im, 55, 56, 49);//背景色
    ...
    private function setDisturb()
    {
        ...
        for ($i = 0; $i < $disturbNum; $i++) {
            $color = imagecolorallocate($this->im, rand(0, 100), rand(0, 100), rand(0, 100));
    ...
    private function setCaptcha()
    {
        ...
        for ($i = 0; $i < $this->codeNum; $i++) {
            $color = imagecolorallocate($this->im, rand(198,222), rand(198,222), rand(198,222));//字符色
